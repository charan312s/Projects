...
public class Voterlogin extends javax.swing.JFrame {   
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VoterLogin page");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query ="SELECT VoterID,Password from voter where VoterID='"+u+"'  AND Password='"+p+"'     ";
        ...
        try{                     
            ...
            if(rs.next()){                                          
                rs.close();
                pst.close();                
                JOptionPane.showMessageDialog(null,"YOU CAN VOTE NOW!"+" "+u +""+p);
                
                setVisible(false);
                VoterMenu info = new VoterMenu();
